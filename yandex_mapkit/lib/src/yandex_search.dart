...
class YandexSearch {
  ...
  static final Map<int, SuggestSessionCallback> _suggestSessionsById =
      Map<int, SuggestSessionCallback>();
  ...
  static Future<CancelSuggestCallback> getSuggestions(
      ...
      String suggestType,
      bool suggestWords,
      SuggestSessionCallback callback) async {
    _channel.setMethodCallHandler(_handleMethodCall);

    final int listenerId = _nextCallbackId++;
    _suggestSessionsById[listenerId] = callback;

    await _channel.invokeMethod<void>('getSuggestions', <String, dynamic>{
  ...
  static Future<void> _cancelSuggestSession(int listenerId) async {
    if (_suggestSessionsById.containsKey(listenerId)) {
      ...
      await _channel.invokeMethod<void>(
          'cancelSuggestSession', <String, dynamic>{'listenerId': listenerId});
    }
  }
