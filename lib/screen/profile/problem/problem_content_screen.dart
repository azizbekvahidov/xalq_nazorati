...
class _ProblemContentScreenState extends State<ProblemContentScreen> {
  ...
  Future<Map<String, dynamic>> getProblems(id) async {
    try {
      ...
      Map<String, String> headers = {"Authorization": "token ${globals.token}"};
      var response = await connect.getHttp(
          '/problems/problem/$id', cardContentState, headers);
                                                                ...
                                                                child:
                                                                  ...
                                                                  child: _data[
                                                                      ...
                                                                      ? GestureDetector(
                                                                          ...
                                                                          child:
                                                                              CachedNetworkImage(imageUrl: "${globals.site_link}${_data["file_2"]}"),
                                                                        )
                                                                      : Container(),
                                                                ),
                                                              ),
                                                                ...
                                                                child:
                                                                  ...
                                                                  child: _data[
                                                                      ...
                                                                      ? GestureDetector(
                                                                          ...
                                                                          child:
                                                                              CachedNetworkImage(imageUrl: "${globals.site_link}${_data["file_3"]}"),
                                                                        )
                                                                      : Container(),
                                                                ),
                                                              ),
                                                                ...
                                                                child:
                                                                  ...
                                                                  child: _data[
                                                                      ...
                                                                      ? GestureDetector(
                                                                          ...
                                                                          child:
                                                                              CachedNetworkImage(imageUrl: "${globals.site_link}${_data["file_4"]}"),
                                                                        )
                                                                      : Container(),
                                                                ),
                                                              ),
