...
_ProblemSolvedRateScreenState problemSolvedRateScreenState;
...
class ProblemSolvedRateScreen extends StatefulWidget {
  ...
  _ProblemSolvedRateScreenState createState() {
    problemSolvedRateScreenState = _ProblemSolvedRateScreenState();
    return problemSolvedRateScreenState;
  }
}
  ...
  Future sendData() async {
    ...
    if (desc != "" && rated != 0 && isSending == false) {
      ...
      var response = await connect.postHttp(
          '/problems/confirm', problemSolvedRateScreenState, headers, data);
