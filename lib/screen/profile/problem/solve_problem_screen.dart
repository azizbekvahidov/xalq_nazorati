...
_SolveProblemScreenState solveProblemScreenState;
...
class SolveProblemScreen extends StatefulWidget {
  ...
  @override
  _SolveProblemScreenState createState() {
    solveProblemScreenState = _SolveProblemScreenState();
    return solveProblemScreenState;
  }
}
            ...
            child: FutureBuilder(
              ...
              builder: (context, snapshot) {
                ...
                if (snapshot.hasData) {
                  ...
                  var executors =
                      result != null ? res['problem']['closed_by'] : {};
                  List _files = result != null ? analyzeFiles(result) : [];
                  List _images =
                      res != null ? analyzeImages(res["problem"]) : [];
