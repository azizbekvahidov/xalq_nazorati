...
_RegisterVerifyScreenState registerVerifyScreenState;
...
class RegisterVerifyScreen extends StatefulWidget {
  ...
  @override
  _RegisterVerifyScreenState createState() {
    registerVerifyScreenState = _RegisterVerifyScreenState();
    return registerVerifyScreenState;
  }
}
  ...
  void resendCode() async {
    if (_start == 0) {
      ...
      var response = await connect.postCoockieHttp(
          '/users/retry-signup-code', registerVerifyScreenState, headers, map);
  ...
  void verify() async {
    ...
    if (!isSend && code != "") {
      try {
        ...
        Map<String, String> headers = {};
        var response = await connect.postCoockieHttp(
            '/users/signup-confirm', registerVerifyScreenState, headers, map);
