...
_PassRecognizeScreenState passRecognizeScreenState;

class PassRecognizeScreen extends StatefulWidget {
  static const routeName = "/register-pass-recognize";

  @override
  _PassRecognizeScreenState createState() {
    passRecognizeScreenState = _PassRecognizeScreenState();
    return passRecognizeScreenState;
  }
}
  ...
  Future sendData() async {
    ...
    if (_value && series != "" && seriesNum != "" && calendar != "") {
      ...
      var response = await connect.postCoockieHttp(
          '/users/retrieve-data', passRecognizeScreenState, headers, map);
