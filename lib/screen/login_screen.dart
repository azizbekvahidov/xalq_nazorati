...
_LoginScreenState loginPageState;
...
class LoginScreen extends StatefulWidget {
  ...
  _LoginScreenState createState() {
    loginPageState = _LoginScreenState();
...
class _LoginScreenState extends State<LoginScreen> {
  ...
  void getLogin() async {
    ...
    var response =
        await connect.postHttp('/users/signin', loginPageState, headers, map);
  ...
  getUser() async {
    ...
    var response =
        await connect.getHttp('/users/profile', loginPageState, headers);
